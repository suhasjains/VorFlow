...
mesh, data, t, u_exact = pickle.load( open(pwd+'/output'+'{:04d}'.format(i)+'.p', "rb" ) )
...
save_frame(mesh,np.abs(data.u_vel - u_exact),'Error',t,ax,pwd+'/error'+'{:04d}'.format(i)+'.png',False)
